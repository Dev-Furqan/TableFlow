...
export const roles = ['owner', 'manager', 'cashier', 'waiter', 'kitchen', 'accountant', 'viewer'];
...
schema.methods.verifyPassword = function (value) { return bcrypt.compare(value, this.passwordHash); };
schema.statics.hashPassword = (value) => bcrypt.hash(value, 12);
